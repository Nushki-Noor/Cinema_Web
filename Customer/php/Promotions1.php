...
<title>CINEPLEX Cinema - Promotions</title>

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="shortcut icon" href="../../Pictures/minilogo.jpg">
<link rel="stylesheet" href="../../Customer/css/Promotions1.css">

<script src="Promotions1.js"> </script>
...
<!--Images-->
<div style="position: absolute; top: 290px; left:300px ;">
    <div class="promo">
        <img src="../../Pictures/promotionpic3.jpg" >
        </div>
    </div>

<div style="position: absolute; top: 290px; left:1000px ;">
    <div class="promo">
        <img src="../../Pictures/promotionpic2.jpg" >
        </div>
    </div>

    <div style="position: absolute; top: 680px; left:300px ;">
    <div class="promo">
        <img src="../../Pictures/promotionpic4.jpg" >
        </div>
    </div>

    <div style="position: absolute; top: 680px; left:900px ;">
    <div class="promo">
        <img src="../../Pictures/promotionpic5.jpg" >
        </div>
    </div>
